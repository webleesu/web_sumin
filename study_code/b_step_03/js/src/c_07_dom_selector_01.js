...
// wrap.style = 'width: 90%; margin: auto; background-color: #fda; padding: 0.5rem'; // 줄바꿈시 에러
wrap.style = 'width: 90%; margin: auto; \
background-color: #fda; padding: 0.5rem'; // 줄바꿈 하고싶다면 \ 넣고 엔터, \ 뒤에는 여백이 있으면 안됨
wrap.style = 'width:90%; margin:auto; background-color:#fda; padding:0.5rem;';

// h1
var h1 = wrap.getElementsByTagName('h1')[0]; // elements - 복수형태이기 떄문에 배열 형태로 담김
// console.log( h1 );
